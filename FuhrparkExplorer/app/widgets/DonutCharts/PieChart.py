...
from app.core.Utils import font_metrics, sort_by_type, longest_name, percentages_from_values
from app.widgets.DonutCharts.SortType import SortType
from app.widgets.DonutCharts._PieSlice import PieSlice
...
class PieChart(QWidget):
    ...
    def __draw_clip(self, painter: QPainter, rect: QRect, /) -> QRect:
        ...
        hole_size: int = int(self.pie_size * 0.1)
    ...
    def __draw_info(self, painter: QPainter, rect: QRect):
            painter.setFont(QFont("Roboto", int(self.height() * 0.025)))
    ...
    def __draw_legend(self, painter: QPainter, rect: QRect):
        font_size: int = int(self.height() * 0.02)
    ...
    def __draw_title(self, painter: QPainter, draw: bool= False ):
        """
        Zeichnet den Title.
        :param painter:
        :return:
    ...
    def pie_size(self) -> int:
        ...
        :return: int
        """
        return int(min(self.width(), self.height()) * PieChart.__PIE_SCALE)
